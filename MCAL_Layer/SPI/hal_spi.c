...
std_ReturneType SPI_Init(const SPI_Config *Config){
...
std_ReturneType SPI_DeInit(const SPI_Config *Config){
    std_ReturneType ret = E_NOT_OK;
...
std_ReturneType SPI_Send_Byte(const SPI_Config *Config, const uint8 _data){
    std_ReturneType ret = E_NOT_OK;
...
std_ReturneType SPI_Read_Byte(const SPI_Config *Config, uint8 *_data){
    std_ReturneType ret = E_NOT_OK;
...
std_ReturneType SPI_Send_Byte_NonBlocking(const SPI_Config *Config, const uint8 _data){
    
}

std_ReturneType SPI_Read_Byte_NonBlocking(const SPI_Config *Config, uint8 *_data){
