...
# 65 "ECU_Layer/LED/../../MCAL_Layer/GPIO/../device_config.h" 2
# 4 "ECU_Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h" 2
...
# 6 "ECU_Layer/LED/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
...
# 5 "ECU_Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h" 2
...
# 51 "ECU_Layer/../MCAL_Layer/Interrupts/mcal_interrupt_config.h"
typedef enum
{
    LOW_PRIORITY,
    HIGH_PRIORITY
...
# 60 "ECU_Layer/../MCAL_Layer/ADC/hal_adc.h"
typedef struct
{
...
# 1 "ECU_Layer/../MCAL_Layer/TIMER0/timer0_hal.h" 1
# 27 "ECU_Layer/../MCAL_Layer/TIMER0/timer0_hal.h"
typedef enum
{
...
# 20 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/../MCAL_Layer/TIMER1/timer1_hal.h" 1
# 25 "ECU_Layer/../MCAL_Layer/TIMER1/timer1_hal.h"
typedef enum
{
    timer_timer1,
    counter_timer1
...
# 21 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/../MCAL_Layer/TIMER2/timer2_hal.h" 1
...
# 22 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/../MCAL_Layer/TIMER3/timer3_hal.h" 1
# 18 "ECU_Layer/../MCAL_Layer/TIMER3/timer3_hal.h"
typedef enum
{
    timer_timer3,
    counter_timer3
...
# 23 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/../MCAL_Layer/CCP1/hal_ccp1.h" 1
# 24 "ECU_Layer/../MCAL_Layer/CCP1/hal_ccp1.h"
typedef enum
{
...
# 141 "ECU_Layer/../MCAL_Layer/CCP1/hal_ccp1.h"
...
# 24 "ECU_Layer/ecu_layer_initialize.h" 2
...
# 25 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/../MCAL_Layer/EUSART/hal_eusart.h" 1
# 19 "ECU_Layer/../MCAL_Layer/EUSART/hal_eusart.h"
typedef enum
{
...
# 79 "ECU_Layer/../MCAL_Layer/EUSART/hal_eusart.h"
typedef union
{
 struct
    {
...
# 26 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/../MCAL_Layer/I2C/hal_i2c.h" 1
# 76 "ECU_Layer/../MCAL_Layer/I2C/hal_i2c.h"
typedef struct
{
 uint8 i2c_mode_cfg ;
...
# 27 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/Ultrasonic_Sensor/Ultrasonic_Sensor.h" 1
...
# 28 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/LM35/LM35.h" 1
...
# 29 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/4_channel_line_tracker/line_tracker.h" 1
...
std_ReturneType Line_Tracker_intialize(const line_tracker_4_pin *line_tracker_obj);
std_ReturneType Line_Tracker_Right_Status(const line_tracker_4_pin *line_tracker_obj , line_tracker_status_t *line_tracker_status);
std_ReturneType Line_Tracker_Center_Status(const line_tracker_4_pin *line_tracker_obj , line_tracker_status_t *line_tracker_status);
std_ReturneType Line_Tracker_Left_Status(const line_tracker_4_pin *line_tracker_obj , line_tracker_status_t *line_tracker_status);
# 30 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/JOY_STICK/joy_stick.h" 1
...
# 31 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/MQ2/mq2.h" 1
...
# 32 "ECU_Layer/ecu_layer_initialize.h" 2

# 1 "ECU_Layer/DHT11/dht11.h" 1
# 15 "ECU_Layer/DHT11/dht11.h"
typedef struct
{
...
# 33 "ECU_Layer/ecu_layer_initialize.h" 2
...
lm35_t lm35_mc =
{
    ...
    .lm35_pin.ANx = 0X0,
    .lm35_pin.Frequency = 0X5,
    .lm35_pin.Time = 0X5,
    .lm35_pin.Justified = 1,
    .lm35_pin.Volte = 0,
};
...
servo_motor_t servo =
{
    ...
    .timer_pin.TIMER0_INTERRUPT_HANDLER = ((void*)0),
...
EUSART_t eusart_pin =
{
    ...
    .EUSART_Framing_Error_Handler = ((void*)0),
    .EUSART_Overrun_Error_Handler = ((void*)0),
};
...
mq2_t mq2_pin =
{
    ...
    .MQ2_pin_analog.ANx = 0X0,
    .MQ2_pin_analog.Frequency = 0X5,
    .MQ2_pin_analog.Justified = 1,
    .MQ2_pin_analog.Time = 0X5,
    .MQ2_pin_analog.Volte = 0,
};
