...
# 1 "MCAL_Layer/EUSART/../Interrupts/mcal_internal_interrupt.h" 1





# 1 "MCAL_Layer/EUSART/../Interrupts/mcal_interrupt_config.h" 1



# 1 "MCAL_Layer/EUSART/../Interrupts/../mcal_std_types.h" 1



# 1 "MCAL_Layer/EUSART/../Interrupts/../std_libraries.h" 1
...
# 4 "MCAL_Layer/EUSART/../Interrupts/../std_libraries.h" 2
...
# 5 "MCAL_Layer/EUSART/../Interrupts/../std_libraries.h" 2
...
# 6 "MCAL_Layer/EUSART/../Interrupts/../std_libraries.h" 2
...
# 7 "MCAL_Layer/EUSART/../Interrupts/../std_libraries.h" 2
# 4 "MCAL_Layer/EUSART/../Interrupts/../mcal_std_types.h" 2

# 1 "MCAL_Layer/EUSART/../Interrupts/../compiler.h" 1
...
# 4 "MCAL_Layer/EUSART/../Interrupts/../compiler.h" 2
# 5 "MCAL_Layer/EUSART/../Interrupts/../mcal_std_types.h" 2
...
# 6 "MCAL_Layer/EUSART/../Interrupts/../mcal_std_types.h" 2
...
# 4 "MCAL_Layer/EUSART/../Interrupts/mcal_interrupt_config.h" 2

# 1 "MCAL_Layer/EUSART/../Interrupts/../GPIO/hal_gpio.h" 1



# 1 "MCAL_Layer/EUSART/../Interrupts/../GPIO/../device_config.h" 1
...
# 4 "MCAL_Layer/EUSART/../Interrupts/../GPIO/hal_gpio.h" 2
# 28 "MCAL_Layer/EUSART/../Interrupts/../GPIO/hal_gpio.h"
typedef enum
{
    LOW,
    HIGH
...
# 5 "MCAL_Layer/EUSART/../Interrupts/mcal_interrupt_config.h" 2
# 51 "MCAL_Layer/EUSART/../Interrupts/mcal_interrupt_config.h"
typedef enum
{
    LOW_PRIORITY,
    HIGH_PRIORITY
}INTERRUPT_PRIORITY_CFG;
# 6 "MCAL_Layer/EUSART/../Interrupts/mcal_internal_interrupt.h" 2
# 4 "MCAL_Layer/EUSART/hal_eusart.h" 2
# 19 "MCAL_Layer/EUSART/hal_eusart.h"
typedef enum
{
...
# 79 "MCAL_Layer/EUSART/hal_eusart.h"
typedef union
{
 struct
    {
...
static void EUSART_RB_Calculation(const EUSART_t *eusart_obj)
{
    ...
    switch(eusart_obj->select_baud_rate_config)
    {
        case Baud_Rate_Asyn_08_bit_Low_speed :
            (TXSTAbits.SYNC = 0x0);
            (TXSTAbits.BRGH = 0x0);
            (BAUDCONbits.BRG16 = 0x0);
            BR_local = (float)(((((float)8000000)/(64.0 * (float)(eusart_obj->RB))) - 1 ));
            break;
        case Baud_Rate_Asyn_08_bit_High_speed :
            (TXSTAbits.SYNC = 0x0);
            (TXSTAbits.BRGH = 0x1);
            (BAUDCONbits.BRG16 = 0x0);
            BR_local = (float)(((((float)8000000)/(16.0 * (float)(eusart_obj->RB))) - 1 ));
            break;
        ...
        case Baud_Rate_Asyn_16_bit_High_speed :
            ...
            (TXSTAbits.BRGH = 0x1);
            (BAUDCONbits.BRG16 = 0x1);
            BR_local = (float)(((((float)8000000)/(4.0 * (float)(eusart_obj->RB))) - 1 ));
            break;
...
# 282 "MCAL_Layer/EUSART/hal_eusart.c"
    (TXSTAbits.TX9 = eusart_obj->select_number_of_bit_transmit);
...
# 318 "MCAL_Layer/EUSART/hal_eusart.c"
    (RCSTAbits.RX9 = eusart_obj->select_number_of_bit_receive);
}
