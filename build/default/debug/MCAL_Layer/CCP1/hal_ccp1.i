...
# 65 "MCAL_Layer/CCP1/../GPIO/../device_config.h" 2
# 4 "MCAL_Layer/CCP1/../GPIO/hal_gpio.h" 2
...
# 4 "MCAL_Layer/CCP1/../GPIO/../std_libraries.h" 2
...
# 6 "MCAL_Layer/CCP1/../GPIO/../std_libraries.h" 2
...
# 7 "MCAL_Layer/CCP1/../GPIO/../std_libraries.h" 2
# 4 "MCAL_Layer/CCP1/../GPIO/../mcal_std_types.h" 2

# 1 "MCAL_Layer/CCP1/../GPIO/../compiler.h" 1
# 5 "MCAL_Layer/CCP1/../GPIO/../mcal_std_types.h" 2
...
# 6 "MCAL_Layer/CCP1/../GPIO/../mcal_std_types.h" 2
...
# 5 "MCAL_Layer/CCP1/../GPIO/hal_gpio.h" 2
# 28 "MCAL_Layer/CCP1/../GPIO/hal_gpio.h"
typedef enum
{
    LOW,
    HIGH
...
# 4 "MCAL_Layer/CCP1/hal_ccp1.h" 2

# 1 "MCAL_Layer/CCP1/../Interrupts/mcal_internal_interrupt.h" 1





# 1 "MCAL_Layer/CCP1/../Interrupts/mcal_interrupt_config.h" 1
# 51 "MCAL_Layer/CCP1/../Interrupts/mcal_interrupt_config.h"
typedef enum
{
    LOW_PRIORITY,
    HIGH_PRIORITY
}INTERRUPT_PRIORITY_CFG;
# 6 "MCAL_Layer/CCP1/../Interrupts/mcal_internal_interrupt.h" 2
# 5 "MCAL_Layer/CCP1/hal_ccp1.h" 2

# 1 "MCAL_Layer/CCP1/../TIMER1/timer1_hal.h" 1
# 25 "MCAL_Layer/CCP1/../TIMER1/timer1_hal.h"
typedef enum
{
    timer_timer1,
    counter_timer1
...
# 6 "MCAL_Layer/CCP1/hal_ccp1.h" 2

# 1 "MCAL_Layer/CCP1/../TIMER2/timer2_hal.h" 1
...
# 7 "MCAL_Layer/CCP1/hal_ccp1.h" 2

# 1 "MCAL_Layer/CCP1/../TIMER3/timer3_hal.h" 1
# 18 "MCAL_Layer/CCP1/../TIMER3/timer3_hal.h"
typedef enum
{
    timer_timer3,
    counter_timer3
...
# 8 "MCAL_Layer/CCP1/hal_ccp1.h" 2
# 24 "MCAL_Layer/CCP1/hal_ccp1.h"
typedef enum
{
...
# 141 "MCAL_Layer/CCP1/hal_ccp1.h"
...
std_ReturneType CCP_initialize(const ccp_config_t *ccp_obj)
{
    ...
    else
    {
        ...
        {
            (CCP1CONbits.CCP1M = Capture_Compare_PWM_disabled);
            if(ccp_obj->ccp_mode == 0)
            {
                switch(ccp_obj->ccp_bits_mode)
                {
                    case Capture_mode_1_every_falling_edge : (CCP1CONbits.CCP1M = Capture_mode_1_every_falling_edge) ; ret = (std_ReturneType)0x01 ; break ;
                    case Capture_mode_1_every_rising_dge : (CCP1CONbits.CCP1M = Capture_mode_1_every_rising_dge) ; ret = (std_ReturneType)0x01 ; break ;
                    case Capture_mode_1_every_4th_rising_edge : (CCP1CONbits.CCP1M = Capture_mode_1_every_4th_rising_edge) ; ret = (std_ReturneType)0x01 ; break ;
                    case Capture_mode_1_every_16th_rising_edge : (CCP1CONbits.CCP1M = Capture_mode_1_every_16th_rising_edge) ; ret = (std_ReturneType)0x01 ; break ;
            ...
            else if(ccp_obj->ccp_mode == 1)
            {
                switch(ccp_obj->ccp_bits_mode)
                {
                    case Compare_mode_set_pin_low : (CCP1CONbits.CCP1M = Compare_mode_set_pin_low) ; ret = (std_ReturneType)0x01 ; break ;
                    case Compare_mode_set_pin_high : (CCP1CONbits.CCP1M = Compare_mode_set_pin_high) ; ret = (std_ReturneType)0x01 ; break ;
                    case Compare_mode_generate_software_interrupt : (CCP1CONbits.CCP1M = Compare_mode_generate_software_interrupt) ; ret = (std_ReturneType)0x01 ; break ;
                    case Compare_mode_trigger_special_event : (CCP1CONbits.CCP1M = Compare_mode_trigger_special_event) ; ret = (std_ReturneType)0x01 ; break ;
                    default : ret = (std_ReturneType)0x00 ;
                }
            }
            else if(ccp_obj->ccp_mode == 2)
            {
                ...
                PR2 = (uint8)((((uint32)8000000) / (((uint32)ccp_obj->pwm_frequency) * 4 * ((uint32)ccp_obj->CCP_Prescaler) ) - 1));
        ...
        {
            (CCP2CONbits.CCP2M = Capture_Compare_PWM_disabled);
            if(ccp_obj->ccp_mode == 0)
            {
                switch(ccp_obj->ccp_bits_mode)
                {
                    case Capture_mode_1_every_falling_edge : (CCP2CONbits.CCP2M = Capture_mode_1_every_falling_edge) ; ret = (std_ReturneType)0x01 ; break ;
                    case Capture_mode_1_every_rising_dge : (CCP2CONbits.CCP2M = Capture_mode_1_every_rising_dge) ; ret = (std_ReturneType)0x01 ; break ;
                    case Capture_mode_1_every_4th_rising_edge : (CCP2CONbits.CCP2M = Capture_mode_1_every_4th_rising_edge) ; ret = (std_ReturneType)0x01 ; break ;
                    case Capture_mode_1_every_16th_rising_edge : (CCP2CONbits.CCP2M = Capture_mode_1_every_16th_rising_edge) ; ret = (std_ReturneType)0x01 ; break ;
                    default : ret = (std_ReturneType)0x00 ;
                }
                if(ccp_obj->ccp_selecte_timer == CCP1_CCP2_TIMER1)
                {
            ...
            else if(ccp_obj->ccp_mode == 1)
            {
                switch(ccp_obj->ccp_bits_mode)
                {
                    case Compare_mode_set_pin_low : (CCP2CONbits.CCP2M = Compare_mode_set_pin_low) ; ret = (std_ReturneType)0x01 ; break ;
                    case Compare_mode_set_pin_high : (CCP2CONbits.CCP2M = Compare_mode_set_pin_high) ; ret = (std_ReturneType)0x01 ; break ;
                    case Compare_mode_generate_software_interrupt : (CCP2CONbits.CCP2M = Compare_mode_generate_software_interrupt) ; ret = (std_ReturneType)0x01 ; break ;
                    case Compare_mode_trigger_special_event : (CCP2CONbits.CCP2M = Compare_mode_trigger_special_event) ; ret = (std_ReturneType)0x01 ; break ;
                    default : ret = (std_ReturneType)0x00 ;
                }
            }
            else if(ccp_obj->ccp_mode == 2)
            {
                ...
                PR2 = (uint8)((((uint32)8000000) / (((uint32)ccp_obj->pwm_frequency) * 4 * ((uint32)ccp_obj->CCP_Prescaler) * ((uint32)ccp_obj->CCP_Postscale)) - 1));
...
# 178 "MCAL_Layer/CCP1/hal_ccp1.c"
        (PIE2bits.CCP2IE = 1);
        (PIR2bits.CCP2IF = 0);
...
# 403 "MCAL_Layer/CCP1/hal_ccp1.c"
std_ReturneType ccp_pwm_duty_cycle(const ccp_config_t *ccp_obj , float duty)
{
    std_ReturneType ret = (std_ReturneType)0x00 ;
    if(ccp_obj == ((void*)0))
